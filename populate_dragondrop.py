...
def populate():
	...
	bmID_152.save()
	bfID_152 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_152,bfrank=0.769823231716)
	bfID_152.save()
	...
	bmID_294.save()
	bfID_294 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_294,bfrank=0.257045860563)
	bfID_294.save()
	...
	bmID_11.save()
	bfID_11 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_11,bfrank=0.25111745193)
	bfID_11.save()
	...
	bmID_299.save()
	bfID_299 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_299,bfrank=0.346233091227)
	bfID_299.save()
	...
	bmID_164.save()
	bfID_164 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_164,bfrank=0.86177345382)
	bfID_164.save()
	...
	bmID_39.save()
	bfID_39 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gozel,bfbookmark=bmID_39,bfrank=0.313594090435)
	bfID_39.save()
	...
	bmID_65.save()
	bfID_65 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_65,bfrank=0.967548554584)
	bfID_65.save()
	...
	bmID_72.save()
	bfID_72 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_72,bfrank=0.0800872456395)
	bfID_72.save()
	...
	bmID_12.save()
	bfID_12 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_12,bfrank=0.470868662852)
	bfID_12.save()
	...
	bmID_274.save()
	bfID_274 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_274,bfrank=0.828486837863)
	bfID_274.save()
	...
	bmID_203.save()
	bfID_203 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_203,bfrank=0.047062473812)
	bfID_203.save()
	...
	bmID_207.save()
	bfID_207 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_207,bfrank=0.508522394443)
	bfID_207.save()
	...
	bmID_54.save()
	bfID_54 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_54,bfrank=0.430918879794)
	bfID_54.save()
	...
	bmID_326.save()
	bfID_326 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_326,bfrank=0.563525323889)
	bfID_326.save()
	...
	bmID_5.save()
	bfID_5 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_5,bfrank=0.994297118681)
	bfID_5.save()
	...
	bmID_87.save()
	bfID_87 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_87,bfrank=0.174850291024)
	bfID_87.save()
	...
	bmID_153.save()
	bfID_153 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_153,bfrank=0.392370116893)
	bfID_153.save()
	...
	bmID_139.save()
	bfID_139 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_139,bfrank=0.819920719818)
	bfID_139.save()
	...
	bmID_88.save()
	bfID_88 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_88,bfrank=0.086268148084)
	bfID_88.save()
	...
	bmID_93.save()
	bfID_93 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_93,bfrank=0.938784394212)
	bfID_93.save()
	...
	bmID_318.save()
	bfID_318 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_318,bfrank=0.784172768025)
	bfID_318.save()
	...
	bmID_82.save()
	bfID_82 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_82,bfrank=0.767056438001)
	bfID_82.save()
	...
	bmID_230.save()
	bfID_230 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_230,bfrank=0.934672651743)
	bfID_230.save()
	...
	bmID_157.save()
	bfID_157 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_157,bfrank=0.52126346653)
	bfID_157.save()
	...
	bmID_244.save()
	bfID_244 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_244,bfrank=0.817704874766)
	bfID_244.save()
	...
	bmID_38.save()
	bfID_38 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_38,bfrank=0.0697154333597)
	bfID_38.save()
	...
	bmID_3.save()
	bfID_3 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gozel,bfbookmark=bmID_3,bfrank=0.6049320887)
	bfID_3.save()
	...
	bmID_270.save()
	bfID_270 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_270,bfrank=0.285505809041)
	bfID_270.save()
	...
	bmID_101.save()
	bfID_101 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_101,bfrank=0.150988299826)
	bfID_101.save()
	...
	bmID_193.save()
	bfID_193 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_193,bfrank=0.156431266727)
	bfID_193.save()
	...
	bmID_225.save()
	bfID_225 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_225,bfrank=0.0894384100001)
	bfID_225.save()
	...
	bmID_185.save()
	bfID_185 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_185,bfrank=0.406669945587)
	bfID_185.save()
	...
	bmID_32.save()
	bfID_32 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_32,bfrank=0.783709916926)
	bfID_32.save()
	...
	bmID_205.save()
	bfID_205 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_205,bfrank=0.354613250794)
	bfID_205.save()
	...
	bmID_200.save()
	bfID_200 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_200,bfrank=0.136766050998)
	bfID_200.save()
	...
	bmID_110.save()
	bfID_110 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_110,bfrank=0.638556383219)
	bfID_110.save()
	...
	bmID_84.save()
	bfID_84 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_84,bfrank=0.816020555719)
	bfID_84.save()
	...
	bmID_154.save()
	bfID_154 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_154,bfrank=0.404386573133)
	bfID_154.save()
	...
	bmID_264.save()
	bfID_264 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_264,bfrank=0.899901560024)
	bfID_264.save()
	...
	bmID_295.save()
	bfID_295 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_295,bfrank=0.118494050721)
	bfID_295.save()
	...
	bmID_22.save()
	bfID_22 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gozel,bfbookmark=bmID_22,bfrank=0.258659004649)
	bfID_22.save()
	...
	bmID_327.save()
	bfID_327 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_327,bfrank=0.648158449327)
	bfID_327.save()
	...
	bmID_55.save()
	bfID_55 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_55,bfrank=0.217135262735)
	bfID_55.save()
	...
	bmID_141.save()
	bfID_141 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_141,bfrank=0.0224675648528)
	bfID_141.save()
	...
	bmID_254.save()
	bfID_254 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_254,bfrank=0.934464225483)
	bfID_254.save()
	...
	bmID_97.save()
	bfID_97 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_97,bfrank=0.428597668104)
	bfID_97.save()
	...
	bmID_136.save()
	bfID_136 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_136,bfrank=0.292337047673)
	bfID_136.save()
	...
	bmID_181.save()
	bfID_181 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_181,bfrank=0.898854131134)
	bfID_181.save()
	...
	bmID_322.save()
	bfID_322 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_322,bfrank=0.0633710217955)
	bfID_322.save()
	...
	bmID_221.save()
	bfID_221 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_221,bfrank=0.901421321631)
	bfID_221.save()
	...
	bmID_44.save()
	bfID_44 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_44,bfrank=0.00549620744351)
	bfID_44.save()
	...
	bmID_320.save()
	bfID_320 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_320,bfrank=0.911878121783)
	bfID_320.save()
	...
	bmID_146.save()
	bfID_146 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_146,bfrank=0.455485836612)
	bfID_146.save()
	...
	bmID_56.save()
	bfID_56 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Wen,bfbookmark=bmID_56,bfrank=0.192251555636)
	bfID_56.save()
	...
	bmID_57.save()
	bfID_57 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_57,bfrank=0.446767006478)
	bfID_57.save()
	...
	bmID_261.save()
	bfID_261 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_261,bfrank=0.330445411022)
	bfID_261.save()
	...
	bmID_34.save()
	bfID_34 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_34,bfrank=0.227574386432)
	bfID_34.save()
	...
	bmID_19.save()
	bfID_19 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_19,bfrank=0.137965696901)
	bfID_19.save()
	...
	bmID_231.save()
	bfID_231 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_231,bfrank=0.181772395697)
	bfID_231.save()
	...
	bmID_293.save()
	bfID_293 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_293,bfrank=0.674893610727)
	bfID_293.save()
	...
	bmID_182.save()
	bfID_182 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_182,bfrank=0.894940795918)
	bfID_182.save()
	...
	bmID_151.save()
	bfID_151 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_151,bfrank=0.0812770135594)
	bfID_151.save()
	...
	bmID_144.save()
	bfID_144 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_144,bfrank=0.119663869158)
	bfID_144.save()
	...
	bmID_245.save()
	bfID_245 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_245,bfrank=0.185709300578)
	bfID_245.save()
	...
	bmID_77.save()
	bfID_77 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_77,bfrank=0.584218948372)
	bfID_77.save()
	...
	bmID_172.save()
	bfID_172 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_172,bfrank=0.577301441213)
	bfID_172.save()
	...
	bmID_195.save()
	bfID_195 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_195,bfrank=0.669106467622)
	bfID_195.save()
	...
	bmID_40.save()
	bfID_40 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gozel,bfbookmark=bmID_40,bfrank=0.628247107608)
	bfID_40.save()
	...
	bmID_330.save()
	bfID_330 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_330,bfrank=0.935914176567)
	bfID_330.save()
	...
	bmID_96.save()
	bfID_96 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_96,bfrank=0.223855149916)
	bfID_96.save()
	...
	bmID_314.save()
	bfID_314 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_314,bfrank=0.175935817936)
	bfID_314.save()
	...
	bmID_324.save()
	bfID_324 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_324,bfrank=0.00821370741322)
	bfID_324.save()
	...
	bmID_302.save()
	bfID_302 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_302,bfrank=0.0985009465337)
	bfID_302.save()
	...
	bmID_126.save()
	bfID_126 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_126,bfrank=0.980306201144)
	bfID_126.save()
	...
	bmID_265.save()
	bfID_265 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_265,bfrank=0.757393154145)
	bfID_265.save()
	...
	bmID_272.save()
	bfID_272 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_272,bfrank=0.00235535002451)
	bfID_272.save()
	...
	bmID_75.save()
	bfID_75 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_75,bfrank=0.560822846891)
	bfID_75.save()
	...
	bmID_0.save()
	bfID_0 = BookmarkToFolder.objects.create(bffolder=f_Maps_Gozel,bfbookmark=bmID_0,bfrank=0.820413019303)
	bfID_0.save()
	...
	bmID_66.save()
	bfID_66 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_66,bfrank=0.00441506877491)
	bfID_66.save()
	...
	bmID_189.save()
	bfID_189 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_189,bfrank=0.513392437812)
	bfID_189.save()
	...
	bmID_119.save()
	bfID_119 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_119,bfrank=0.518013905631)
	bfID_119.save()
	...
	bmID_135.save()
	bfID_135 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_135,bfrank=0.45323560889)
	bfID_135.save()
	...
	bmID_300.save()
	bfID_300 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_300,bfrank=0.410220449014)
	bfID_300.save()
	...
	bmID_248.save()
	bfID_248 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_248,bfrank=0.204807306805)
	bfID_248.save()
	...
	bmID_115.save()
	bfID_115 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_115,bfrank=0.297125931337)
	bfID_115.save()
	...
	bmID_329.save()
	bfID_329 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_329,bfrank=0.741140451161)
	bfID_329.save()
	...
	bmID_158.save()
	bfID_158 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_158,bfrank=0.195874495416)
	bfID_158.save()
	...
	bmID_186.save()
	bfID_186 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_186,bfrank=0.250021399713)
	bfID_186.save()
	...
	bmID_28.save()
	bfID_28 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_28,bfrank=0.74824783115)
	bfID_28.save()
	...
	bmID_167.save()
	bfID_167 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_167,bfrank=0.863531818431)
	bfID_167.save()
	...
	bmID_194.save()
	bfID_194 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_194,bfrank=0.664736934017)
	bfID_194.save()
	...
	bmID_199.save()
	bfID_199 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_199,bfrank=0.911845850969)
	bfID_199.save()
	...
	bmID_145.save()
	bfID_145 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_145,bfrank=0.527643328548)
	bfID_145.save()
	...
	bmID_262.save()
	bfID_262 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_262,bfrank=0.515293449016)
	bfID_262.save()
	...
	bmID_6.save()
	bfID_6 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_6,bfrank=0.186245778414)
	bfID_6.save()
	...
	bmID_86.save()
	bfID_86 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_86,bfrank=0.194121024035)
	bfID_86.save()
	...
	bmID_197.save()
	bfID_197 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_197,bfrank=0.262267122867)
	bfID_197.save()
	...
	bmID_260.save()
	bfID_260 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_260,bfrank=0.439352709197)
	bfID_260.save()
	...
	bmID_171.save()
	bfID_171 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_171,bfrank=0.408345592875)
	bfID_171.save()
	...
	bmID_134.save()
	bfID_134 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_134,bfrank=0.754060349862)
	bfID_134.save()
	...
	bmID_304.save()
	bfID_304 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_304,bfrank=0.124161803445)
	bfID_304.save()
	...
	bmID_64.save()
	bfID_64 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_64,bfrank=0.940995128012)
	bfID_64.save()
	...
	bmID_257.save()
	bfID_257 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_257,bfrank=0.57480499895)
	bfID_257.save()
	...
	bmID_243.save()
	bfID_243 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_243,bfrank=0.674339816923)
	bfID_243.save()
	...
	bmID_80.save()
	bfID_80 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_80,bfrank=0.597994770148)
	bfID_80.save()
	...
	bmID_306.save()
	bfID_306 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_306,bfrank=0.622880957655)
	bfID_306.save()
	...
	bmID_9.save()
	bfID_9 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_9,bfrank=0.411389611799)
	bfID_9.save()
	...
	bmID_102.save()
	bfID_102 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_102,bfrank=0.0599756676379)
	bfID_102.save()
	...
	bmID_165.save()
	bfID_165 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_165,bfrank=0.0992374595363)
	bfID_165.save()
	...
	bmID_91.save()
	bfID_91 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_91,bfrank=0.540144575675)
	bfID_91.save()
	...
	bmID_315.save()
	bfID_315 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_315,bfrank=0.819110589256)
	bfID_315.save()
	...
	bmID_170.save()
	bfID_170 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_170,bfrank=0.534142567878)
	bfID_170.save()
	...
	bmID_53.save()
	bfID_53 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_53,bfrank=0.351078712063)
	bfID_53.save()
	...
	bmID_163.save()
	bfID_163 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_163,bfrank=0.551572859898)
	bfID_163.save()
	...
	bmID_308.save()
	bfID_308 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_308,bfrank=0.347444903603)
	bfID_308.save()
	bmID_252,bmID_b_252 = Bookmark.objects.get_or_create(url='http://dimplejs.org/')
	bmID_252.btitle='Dimple'
	bmID_252.bdescr='Dimple'
	bmID_252.save()
	bfID_252 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_252,bfrank=0.577818174355)
	bfID_252.save()
	...
	bmID_303.save()
	bfID_303 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_303,bfrank=0.609364074622)
	bfID_303.save()
	...
	bmID_147.save()
	bfID_147 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_147,bfrank=0.751336668922)
	bfID_147.save()
	...
	bmID_275.save()
	bfID_275 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_275,bfrank=0.829687096698)
	bfID_275.save()
	...
	bmID_213.save()
	bfID_213 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_213,bfrank=0.93686547909)
	bfID_213.save()
	...
	bmID_178.save()
	bfID_178 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_178,bfrank=0.145549173413)
	bfID_178.save()
	...
	bmID_128.save()
	bfID_128 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_128,bfrank=0.298596813272)
	bfID_128.save()
	...
	bmID_208.save()
	bfID_208 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_208,bfrank=0.322454419042)
	bfID_208.save()
	...
	bmID_176.save()
	bfID_176 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_176,bfrank=0.94148063779)
	bfID_176.save()
	...
	bmID_283.save()
	bfID_283 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_283,bfrank=0.1466751704)
	bfID_283.save()
	...
	bmID_124.save()
	bfID_124 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_124,bfrank=0.262791025986)
	bfID_124.save()
	...
	bmID_100.save()
	bfID_100 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_100,bfrank=0.57981658629)
	bfID_100.save()
	...
	bmID_47.save()
	bfID_47 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_47,bfrank=0.135538838807)
	bfID_47.save()
	...
	bmID_323.save()
	bfID_323 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_323,bfrank=0.217436272304)
	bfID_323.save()
	...
	bmID_173.save()
	bfID_173 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_173,bfrank=0.310199370322)
	bfID_173.save()
	...
	bmID_187.save()
	bfID_187 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_187,bfrank=0.684017283595)
	bfID_187.save()
	...
	bmID_46.save()
	bfID_46 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_46,bfrank=0.552177391288)
	bfID_46.save()
	...
	bmID_198.save()
	bfID_198 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_198,bfrank=0.782239468567)
	bfID_198.save()
	...
	bmID_10.save()
	bfID_10 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_10,bfrank=0.106516335337)
	bfID_10.save()
	...
	bmID_127.save()
	bfID_127 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_127,bfrank=0.813453794292)
	bfID_127.save()
	...
	bmID_255.save()
	bfID_255 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_255,bfrank=0.836517881807)
	bfID_255.save()
	...
	bmID_121.save()
	bfID_121 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_121,bfrank=0.271009832161)
	bfID_121.save()
	...
	bmID_14.save()
	bfID_14 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_14,bfrank=0.605295692477)
	bfID_14.save()
	...
	bmID_1.save()
	bfID_1 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_1,bfrank=0.919531632196)
	bfID_1.save()
	...
	bmID_258.save()
	bfID_258 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_258,bfrank=0.0599053760711)
	bfID_258.save()
	...
	bmID_111.save()
	bfID_111 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_111,bfrank=0.0791950776209)
	bfID_111.save()
	...
	bmID_15.save()
	bfID_15 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_15,bfrank=0.0640424794698)
	bfID_15.save()
	...
	bmID_268.save()
	bfID_268 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_268,bfrank=0.247450028247)
	bfID_268.save()
	...
	bmID_33.save()
	bfID_33 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_33,bfrank=0.858222103596)
	bfID_33.save()
	...
	bmID_162.save()
	bfID_162 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_162,bfrank=0.320805076638)
	bfID_162.save()
	...
	bmID_216.save()
	bfID_216 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_216,bfrank=0.56943216347)
	bfID_216.save()
	...
	bmID_214.save()
	bfID_214 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_214,bfrank=0.72194258352)
	bfID_214.save()
	...
	bmID_236.save()
	bfID_236 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_236,bfrank=0.576150048991)
	bfID_236.save()
	...
	bmID_122.save()
	bfID_122 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_122,bfrank=0.148325969483)
	bfID_122.save()
	...
	bmID_45.save()
	bfID_45 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_45,bfrank=0.505392803269)
	bfID_45.save()
	...
	bmID_27.save()
	bfID_27 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_27,bfrank=0.740419683791)
	bfID_27.save()
	...
	bmID_78.save()
	bfID_78 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_78,bfrank=0.662977390463)
	bfID_78.save()
	...
	bmID_161.save()
	bfID_161 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_161,bfrank=0.898855683327)
	bfID_161.save()
	...
	bmID_296.save()
	bfID_296 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_296,bfrank=0.752486179858)
	bfID_296.save()
	...
	bmID_179.save()
	bfID_179 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_179,bfrank=0.765092856447)
	bfID_179.save()
	...
	bmID_30.save()
	bfID_30 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_30,bfrank=0.787153617341)
	bfID_30.save()
	...
	bmID_271.save()
	bfID_271 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_271,bfrank=0.232280341144)
	bfID_271.save()
	...
	bmID_288.save()
	bfID_288 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_288,bfrank=0.90949834705)
	bfID_288.save()
	...
	bmID_317.save()
	bfID_317 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_317,bfrank=0.797180406086)
	bfID_317.save()
	...
	bmID_160.save()
	bfID_160 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_160,bfrank=0.877191926167)
	bfID_160.save()
	...
	bmID_4.save()
	bfID_4 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gozel,bfbookmark=bmID_4,bfrank=0.406045514361)
	bfID_4.save()
	...
	bmID_209.save()
	bfID_209 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_209,bfrank=0.34775625385)
	bfID_209.save()
	...
	bmID_204.save()
	bfID_204 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_204,bfrank=0.381275701347)
	bfID_204.save()
	...
	bmID_105.save()
	bfID_105 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_105,bfrank=0.365843703762)
	bfID_105.save()
	...
	bmID_92.save()
	bfID_92 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_92,bfrank=0.00748991736539)
	bfID_92.save()
	...
	bmID_175.save()
	bfID_175 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_175,bfrank=0.863268258771)
	bfID_175.save()
	...
	bmID_241.save()
	bfID_241 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_241,bfrank=0.746685821214)
	bfID_241.save()
	...
	bmID_18.save()
	bfID_18 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_18,bfrank=0.252417050105)
	bfID_18.save()
	...
	bmID_31.save()
	bfID_31 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_31,bfrank=0.3393464669)
	bfID_31.save()
	...
	bmID_94.save()
	bfID_94 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_94,bfrank=0.593004697577)
	bfID_94.save()
	...
	bmID_259.save()
	bfID_259 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_259,bfrank=0.922074980739)
	bfID_259.save()
	...
	bmID_316.save()
	bfID_316 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_316,bfrank=0.334816000825)
	bfID_316.save()
	...
	bmID_219.save()
	bfID_219 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_219,bfrank=0.621994203022)
	bfID_219.save()
	...
	bmID_218.save()
	bfID_218 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_218,bfrank=0.47618163128)
	bfID_218.save()
	...
	bmID_26.save()
	bfID_26 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gozel,bfbookmark=bmID_26,bfrank=0.831337141029)
	bfID_26.save()
	...
	bmID_20.save()
	bfID_20 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_20,bfrank=0.725338033498)
	bfID_20.save()
	...
	bmID_155.save()
	bfID_155 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_155,bfrank=0.662274959402)
	bfID_155.save()
	...
	bmID_235.save()
	bfID_235 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_235,bfrank=0.0407474529599)
	bfID_235.save()
	...
	bmID_284.save()
	bfID_284 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_284,bfrank=0.779972578688)
	bfID_284.save()
	...
	bmID_68.save()
	bfID_68 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_68,bfrank=0.440172402021)
	bfID_68.save()
	...
	bmID_85.save()
	bfID_85 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_85,bfrank=0.630905237058)
	bfID_85.save()
	...
	bmID_267.save()
	bfID_267 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_267,bfrank=0.9799306995)
	bfID_267.save()
	...
	bmID_168.save()
	bfID_168 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_168,bfrank=0.871828417653)
	bfID_168.save()
	...
	bmID_23.save()
	bfID_23 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gozel,bfbookmark=bmID_23,bfrank=0.888021120614)
	bfID_23.save()
	...
	bmID_291.save()
	bfID_291 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_291,bfrank=0.729913720914)
	bfID_291.save()
	...
	bmID_76.save()
	bfID_76 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_76,bfrank=0.672357688478)
	bfID_76.save()
	...
	bmID_83.save()
	bfID_83 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_83,bfrank=0.215250451653)
	bfID_83.save()
	...
	bmID_279.save()
	bfID_279 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_279,bfrank=0.351009118101)
	bfID_279.save()
	...
	bmID_13.save()
	bfID_13 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_13,bfrank=0.889671896754)
	bfID_13.save()
	...
	bmID_104.save()
	bfID_104 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_104,bfrank=0.956620505261)
	bfID_104.save()
	...
	bmID_63.save()
	bfID_63 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_63,bfrank=0.708338531494)
	bfID_63.save()
	...
	bmID_266.save()
	bfID_266 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_266,bfrank=0.0794445099862)
	bfID_266.save()
	...
	bmID_120.save()
	bfID_120 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_120,bfrank=0.382936809443)
	bfID_120.save()
	...
	bmID_281.save()
	bfID_281 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_281,bfrank=0.455421528087)
	bfID_281.save()
	...
	bmID_150.save()
	bfID_150 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_150,bfrank=0.484083151367)
	bfID_150.save()
	...
	bmID_287.save()
	bfID_287 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_287,bfrank=0.438063272788)
	bfID_287.save()
	...
	bmID_278.save()
	bfID_278 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_278,bfrank=0.255903068218)
	bfID_278.save()
	...
	bmID_285.save()
	bfID_285 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_285,bfrank=0.830822226953)
	bfID_285.save()
	...
	bmID_132.save()
	bfID_132 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_132,bfrank=0.863540756457)
	bfID_132.save()
	...
	bmID_69.save()
	bfID_69 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_69,bfrank=0.155619615823)
	bfID_69.save()
	...
	bmID_188.save()
	bfID_188 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_188,bfrank=0.340670422259)
	bfID_188.save()
	...
	bmID_263.save()
	bfID_263 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_263,bfrank=0.217123868968)
	bfID_263.save()
	...
	bmID_240.save()
	bfID_240 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_240,bfrank=0.496224636558)
	bfID_240.save()
	...
	bmID_196.save()
	bfID_196 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_196,bfrank=0.633766045825)
	bfID_196.save()
	...
	bmID_123.save()
	bfID_123 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_123,bfrank=0.822409335668)
	bfID_123.save()
	...
	bmID_74.save()
	bfID_74 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_74,bfrank=0.208566243216)
	bfID_74.save()
	...
	bmID_206.save()
	bfID_206 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_206,bfrank=0.812413721165)
	bfID_206.save()
	...
	bmID_319.save()
	bfID_319 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_319,bfrank=0.797797209615)
	bfID_319.save()
	...
	bmID_2.save()
	bfID_2 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gozel,bfbookmark=bmID_2,bfrank=0.997518638339)
	bfID_2.save()
	...
	bmID_143.save()
	bfID_143 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_143,bfrank=0.583551292824)
	bfID_143.save()
	...
	bmID_29.save()
	bfID_29 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_29,bfrank=0.046832862539)
	bfID_29.save()
	bmID_251,bmID_b_251 = Bookmark.objects.get_or_create(url='http://nvd3.org/')
	bmID_251.btitle='NVD3'
	bmID_251.bdescr='NVD3'
	bmID_251.save()
	bfID_251 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_251,bfrank=0.0700501979334)
	bfID_251.save()
	...
	bmID_276.save()
	bfID_276 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_276,bfrank=0.601287706767)
	bfID_276.save()
	...
	bmID_112.save()
	bfID_112 = BookmarkToFolder.objects.create(bffolder=f_Maps_Jean,bfbookmark=bmID_112,bfrank=0.67837508452)
	bfID_112.save()
	...
	bmID_298.save()
	bfID_298 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_298,bfrank=0.964880385535)
	bfID_298.save()
	...
	bmID_191.save()
	bfID_191 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_191,bfrank=0.0745395364443)
	bfID_191.save()
	...
	bmID_129.save()
	bfID_129 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_129,bfrank=0.787872512555)
	bfID_129.save()
	...
	bmID_117.save()
	bfID_117 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_117,bfrank=0.0479938259465)
	bfID_117.save()
	...
	bmID_177.save()
	bfID_177 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_177,bfrank=0.583250997154)
	bfID_177.save()
	...
	bmID_217.save()
	bfID_217 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_217,bfrank=0.759883854921)
	bfID_217.save()
	...
	bmID_99.save()
	bfID_99 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_99,bfrank=0.649591488643)
	bfID_99.save()
	...
	bmID_59.save()
	bfID_59 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_59,bfrank=0.493394677008)
	bfID_59.save()
	...
	bmID_280.save()
	bfID_280 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_280,bfrank=0.119628227795)
	bfID_280.save()
	...
	bmID_313.save()
	bfID_313 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_313,bfrank=0.315928235045)
	bfID_313.save()
	...
	bmID_108.save()
	bfID_108 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_108,bfrank=0.650214968831)
	bfID_108.save()
	...
	bmID_81.save()
	bfID_81 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_81,bfrank=0.0251817873708)
	bfID_81.save()
	...
	bmID_25.save()
	bfID_25 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gozel,bfbookmark=bmID_25,bfrank=0.626253088121)
	bfID_25.save()
	...
	bmID_239.save()
	bfID_239 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_239,bfrank=0.323481162028)
	bfID_239.save()
	...
	bmID_328.save()
	bfID_328 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_328,bfrank=0.361277837919)
	bfID_328.save()
	...
	bmID_58.save()
	bfID_58 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_58,bfrank=0.785689005627)
	bfID_58.save()
	...
	bmID_246.save()
	bfID_246 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_246,bfrank=0.123991094233)
	bfID_246.save()
	...
	bmID_202.save()
	bfID_202 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_202,bfrank=0.54938863667)
	bfID_202.save()
	...
	bmID_237.save()
	bfID_237 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_237,bfrank=0.206273126036)
	bfID_237.save()
	...
	bmID_116.save()
	bfID_116 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_116,bfrank=0.174904096899)
	bfID_116.save()
	...
	bmID_269.save()
	bfID_269 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_269,bfrank=0.633382357604)
	bfID_269.save()
	...
	bmID_190.save()
	bfID_190 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_190,bfrank=0.62598934204)
	bfID_190.save()
	...
	bmID_292.save()
	bfID_292 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_292,bfrank=0.900423548154)
	bfID_292.save()
	...
	bmID_301.save()
	bfID_301 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_301,bfrank=0.214074527358)
	bfID_301.save()
	...
	bmID_138.save()
	bfID_138 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_138,bfrank=0.101348323206)
	bfID_138.save()
	...
	bmID_114.save()
	bfID_114 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_114,bfrank=0.202627051343)
	bfID_114.save()
	...
	bmID_137.save()
	bfID_137 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_137,bfrank=0.776547481097)
	bfID_137.save()
	...
	bmID_229.save()
	bfID_229 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_229,bfrank=0.472142762355)
	bfID_229.save()
	...
	bmID_51.save()
	bfID_51 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_51,bfrank=0.297391538202)
	bfID_51.save()
	...
	bmID_321.save()
	bfID_321 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_321,bfrank=0.6999830199)
	bfID_321.save()
	...
	bmID_130.save()
	bfID_130 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_130,bfrank=0.79947869816)
	bfID_130.save()
	...
	bmID_226.save()
	bfID_226 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Jean,bfbookmark=bmID_226,bfrank=0.194387204249)
	bfID_226.save()
	...
	bmID_7.save()
	bfID_7 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_7,bfrank=0.920840276699)
	bfID_7.save()
	...
	bmID_273.save()
	bfID_273 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_273,bfrank=0.608023489097)
	bfID_273.save()
	...
	bmID_148.save()
	bfID_148 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_148,bfrank=0.950134202212)
	bfID_148.save()
	...
	bmID_60.save()
	bfID_60 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_60,bfrank=0.308038279573)
	bfID_60.save()
	...
	bmID_89.save()
	bfID_89 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_89,bfrank=0.560870251611)
	bfID_89.save()
	...
	bmID_282.save()
	bfID_282 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_282,bfrank=0.0336498465866)
	bfID_282.save()
	...
	bmID_238.save()
	bfID_238 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_238,bfrank=0.65367728536)
	bfID_238.save()
	...
	bmID_106.save()
	bfID_106 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_106,bfrank=0.042568453758)
	bfID_106.save()
	...
	bmID_309.save()
	bfID_309 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_309,bfrank=0.735948870916)
	bfID_309.save()
	...
	bmID_125.save()
	bfID_125 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_125,bfrank=0.491807621197)
	bfID_125.save()
	...
	bmID_227.save()
	bfID_227 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Jean,bfbookmark=bmID_227,bfrank=0.270990554237)
	bfID_227.save()
	...
	bmID_70.save()
	bfID_70 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_70,bfrank=0.371056608416)
	bfID_70.save()
	...
	bmID_37.save()
	bfID_37 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_37,bfrank=0.810521222547)
	bfID_37.save()
	...
	bmID_250.save()
	bfID_250 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_250,bfrank=0.269182885183)
	bfID_250.save()
	...
	bmID_133.save()
	bfID_133 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_133,bfrank=0.141277596984)
	bfID_133.save()
	...
	bmID_210.save()
	bfID_210 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_210,bfrank=0.718271699851)
	bfID_210.save()
	...
	bmID_90.save()
	bfID_90 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_90,bfrank=0.981251743021)
	bfID_90.save()
	...
	bmID_8.save()
	bfID_8 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gozel,bfbookmark=bmID_8,bfrank=0.453004645973)
	bfID_8.save()
	...
	bmID_184.save()
	bfID_184 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_184,bfrank=0.947240098961)
	bfID_184.save()
	...
	bmID_253.save()
	bfID_253 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_253,bfrank=0.150240074157)
	bfID_253.save()
	...
	bmID_223.save()
	bfID_223 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_223,bfrank=0.954869747613)
	bfID_223.save()
	...
	bmID_325.save()
	bfID_325 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_325,bfrank=0.806210748978)
	bfID_325.save()
	...
	bmID_24.save()
	bfID_24 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gozel,bfbookmark=bmID_24,bfrank=0.440156678935)
	bfID_24.save()
	...
	bmID_277.save()
	bfID_277 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_277,bfrank=0.154352104063)
	bfID_277.save()
	...
	bmID_16.save()
	bfID_16 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_16,bfrank=0.924850172826)
	bfID_16.save()
	...
	bmID_220.save()
	bfID_220 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_220,bfrank=0.572150381917)
	bfID_220.save()
	...
	bmID_305.save()
	bfID_305 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_305,bfrank=0.847212467417)
	bfID_305.save()
	...
	bmID_222.save()
	bfID_222 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_222,bfrank=0.682792627476)
	bfID_222.save()
	...
	bmID_212.save()
	bfID_212 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_212,bfrank=0.60263145931)
	bfID_212.save()
	...
	bmID_211.save()
	bfID_211 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_211,bfrank=0.38724264716)
	bfID_211.save()
	...
	bmID_311.save()
	bfID_311 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_311,bfrank=0.101383246118)
	bfID_311.save()
	...
	bmID_118.save()
	bfID_118 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_118,bfrank=0.971787577934)
	bfID_118.save()
	...
	bmID_73.save()
	bfID_73 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_73,bfrank=0.0462636860473)
	bfID_73.save()
	...
	bmID_247.save()
	bfID_247 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_247,bfrank=0.260514778145)
	bfID_247.save()
	...
	bmID_71.save()
	bfID_71 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_71,bfrank=0.138417616868)
	bfID_71.save()
	...
	bmID_109.save()
	bfID_109 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_109,bfrank=0.715934940465)
	bfID_109.save()
	...
	bmID_17.save()
	bfID_17 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_17,bfrank=0.980148913723)
	bfID_17.save()
	...
	bmID_35.save()
	bfID_35 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_35,bfrank=0.143110808239)
	bfID_35.save()
	...
	bmID_67.save()
	bfID_67 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_67,bfrank=0.653730776513)
	bfID_67.save()
	...
	bmID_256.save()
	bfID_256 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_256,bfrank=0.0580673606534)
	bfID_256.save()
	...
	bmID_156.save()
	bfID_156 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_156,bfrank=0.458978137359)
	bfID_156.save()
	...
	bmID_103.save()
	bfID_103 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_103,bfrank=0.883888660765)
	bfID_103.save()
	...
	bmID_215.save()
	bfID_215 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_215,bfrank=0.847725218843)
	bfID_215.save()
	...
	bmID_21.save()
	bfID_21 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gozel,bfbookmark=bmID_21,bfrank=0.461919654702)
	bfID_21.save()
	...
	bmID_286.save()
	bfID_286 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_286,bfrank=0.855898303626)
	bfID_286.save()
	...
	bmID_201.save()
	bfID_201 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_201,bfrank=0.116958210519)
	bfID_201.save()
	...
	bmID_166.save()
	bfID_166 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_166,bfrank=0.778973446229)
	bfID_166.save()
	...
	bmID_79.save()
	bfID_79 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_79,bfrank=0.416432557477)
	bfID_79.save()
	...
	bmID_149.save()
	bfID_149 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_149,bfrank=0.867992690049)
	bfID_149.save()
	...
	bmID_48.save()
	bfID_48 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_48,bfrank=0.911146124546)
	bfID_48.save()
	...
	bmID_140.save()
	bfID_140 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_140,bfrank=0.287249075217)
	bfID_140.save()
	...
	bmID_142.save()
	bfID_142 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_142,bfrank=0.754248575844)
	bfID_142.save()
	...
	bmID_49.save()
	bfID_49 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_49,bfrank=0.577867041838)
	bfID_49.save()
	...
	bmID_233.save()
	bfID_233 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_233,bfrank=0.741019452976)
	bfID_233.save()
	...
	bmID_61.save()
	bfID_61 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_61,bfrank=0.82559989763)
	bfID_61.save()
	...
	bmID_234.save()
	bfID_234 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_234,bfrank=0.339616764708)
	bfID_234.save()
	...
	bmID_62.save()
	bfID_62 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_62,bfrank=0.655062430568)
	bfID_62.save()
	...
	bmID_249.save()
	bfID_249 = BookmarkToFolder.objects.create(bffolder=f_Store_Apps_Martyna,bfbookmark=bmID_249,bfrank=0.559481284212)
	bfID_249.save()
	...
	bmID_50.save()
	bfID_50 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_50,bfrank=0.493037704076)
	bfID_50.save()
	...
	bmID_180.save()
	bfID_180 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_180,bfrank=0.51228289576)
	bfID_180.save()
	...
	bmID_159.save()
	bfID_159 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_159,bfrank=0.665097212696)
	bfID_159.save()
	...
	bmID_289.save()
	bfID_289 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_289,bfrank=0.494899303288)
	bfID_289.save()
	...
	bmID_192.save()
	bfID_192 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_192,bfrank=0.0970495207843)
	bfID_192.save()
	...
	bmID_98.save()
	bfID_98 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_98,bfrank=0.59511397023)
	bfID_98.save()
	...
	bmID_297.save()
	bfID_297 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_297,bfrank=0.439364445304)
	bfID_297.save()
	...
	bmID_36.save()
	bfID_36 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gozel,bfbookmark=bmID_36,bfrank=0.683446350945)
	bfID_36.save()
	...
	bmID_307.save()
	bfID_307 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_307,bfrank=0.0821362222297)
	bfID_307.save()
	...
	bmID_290.save()
	bfID_290 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_290,bfrank=0.249508545589)
	bfID_290.save()
	...
	bmID_41.save()
	bfID_41 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gozel,bfbookmark=bmID_41,bfrank=0.821828353898)
	bfID_41.save()
	...
	bmID_224.save()
	bfID_224 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_224,bfrank=0.619526732782)
	bfID_224.save()
	...
	bmID_183.save()
	bfID_183 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_183,bfrank=0.488822731992)
	bfID_183.save()
	...
	bmID_169.save()
	bfID_169 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_169,bfrank=0.768310894987)
	bfID_169.save()
	...
	bmID_242.save()
	bfID_242 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_242,bfrank=0.223668677162)
	bfID_242.save()
	...
	bmID_131.save()
	bfID_131 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_131,bfrank=0.208292556944)
	bfID_131.save()
	...
	bmID_42.save()
	bfID_42 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gozel,bfbookmark=bmID_42,bfrank=0.0698238609785)
	bfID_42.save()
	...
	bmID_312.save()
	bfID_312 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_312,bfrank=0.11644322886)
	bfID_312.save()
	...
	bmID_174.save()
	bfID_174 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_174,bfrank=0.832436575086)
	bfID_174.save()
	...
	bmID_113.save()
	bfID_113 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_113,bfrank=0.510182967856)
	bfID_113.save()
	...
	bmID_310.save()
	bfID_310 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_310,bfrank=0.489439994613)
	bfID_310.save()
	...
	bmID_43.save()
	bfID_43 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gozel,bfbookmark=bmID_43,bfrank=0.342212344916)
	bfID_43.save()
	...
	bmID_228.save()
	bfID_228 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_228,bfrank=0.68235363846)
	bfID_228.save()
	...
	bmID_232.save()
	bfID_232 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_232,bfrank=0.593009377517)
	bfID_232.save()
	...
	bmID_95.save()
	bfID_95 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_95,bfrank=0.393882749541)
	bfID_95.save()
	...
	bmID_52.save()
	bfID_52 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gozel,bfbookmark=bmID_52,bfrank=0.70328787189)
	bfID_52.save()
	...
	bmID_107.save()
	bfID_107 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_107,bfrank=0.0819267035201)
	bfID_107.save()
