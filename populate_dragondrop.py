...
def populate():
	...
	bmID_272.save()
	bfID_272 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_272)
	bfID_272.save()
	...
	bmID_308.save()
	bfID_308 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_308)
	bfID_308.save()
	...
	bmID_11.save()
	bfID_11 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_11)
	bfID_11.save()
	...
	bmID_128.save()
	bfID_128 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_128)
	bfID_128.save()
	bmID_64,bmID_b_64 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1062383')
	bmID_64.btitle='Symbols'
	bmID_64.save()
	bfID_64 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_64)
	bfID_64.save()
	...
	bmID_150.save()
	bfID_150 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_150)
	bfID_150.save()
	...
	bmID_235.save()
	bfID_235 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Jean,bfbookmark=bmID_235)
	bfID_235.save()
	...
	bmID_299.save()
	bfID_299 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_299)
	bfID_299.save()
	bmID_259,bmID_b_259 = Bookmark.objects.get_or_create(url='http://nickqizhu.github.com/dc.js/')
	bmID_259.btitle='Dc js'
	bmID_259.save()
	bfID_259 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_259)
	bfID_259.save()
	...
	bmID_333.save()
	bfID_333 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_333)
	bfID_333.save()
	...
	bmID_183.save()
	bfID_183 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_183)
	bfID_183.save()
	...
	bmID_117.save()
	bfID_117 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_117)
	bfID_117.save()
	...
	bmID_152.save()
	bfID_152 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_152)
	bfID_152.save()
	...
	bmID_27.save()
	bfID_27 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gosel,bfbookmark=bmID_27)
	bfID_27.save()
	bmID_146,bmID_b_146 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1098617')
	bmID_146.btitle='Arc Tweens'
	bmID_146.save()
	bfID_146 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_146)
	bfID_146.save()
	...
	bmID_1.save()
	bfID_1 = BookmarkToFolder.objects.create(bffolder=f_Evaluation_Gosel,bfbookmark=bmID_1)
	bfID_1.save()
	bmID_169,bmID_b_169 = Bookmark.objects.get_or_create(url='http://metro.ezyang.com/')
	bmID_169.btitle='Metro Maps of the News'
	bmID_169.save()
	bfID_169 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_169)
	bfID_169.save()
	...
	bmID_118.save()
	bfID_118 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_118)
	bfID_118.save()
	...
	bmID_40.save()
	bfID_40 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_40)
	bfID_40.save()
	...
	bmID_130.save()
	bfID_130 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_130)
	bfID_130.save()
	...
	bmID_45.save()
	bfID_45 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_45)
	bfID_45.save()
	bmID_108,bmID_b_108 = Bookmark.objects.get_or_create(url='http://fleetinbeing.net/d3e/chord.html')
	bmID_108.btitle='Updating data'
	bmID_108.save()
	bfID_108 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_108)
	bfID_108.save()
	...
	bmID_231.save()
	bfID_231 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_231)
	bfID_231.save()
	...
	bmID_271.save()
	bfID_271 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_271)
	bfID_271.save()
	...
	bmID_134.save()
	bfID_134 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_134)
	bfID_134.save()
	...
	bmID_180.save()
	bfID_180 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_180)
	bfID_180.save()
	...
	bmID_77.save()
	bfID_77 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_77)
	bfID_77.save()
	bmID_136,bmID_b_136 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1016220')
	bmID_136.btitle='Line Tension'
	bmID_136.save()
	bfID_136 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_136)
	bfID_136.save()
	bmID_177,bmID_b_177 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1367999')
	bmID_177.btitle='PJAX'
	bmID_177.save()
	bfID_177 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_177)
	bfID_177.save()
	...
	bmID_192.save()
	bfID_192 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_192)
	bfID_192.save()
	...
	bmID_100.save()
	bfID_100 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_100)
	bfID_100.save()
	...
	bmID_132.save()
	bfID_132 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_132)
	bfID_132.save()
	...
	bmID_154.save()
	bfID_154 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_154)
	bfID_154.save()
	...
	bmID_121.save()
	bfID_121 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_121)
	bfID_121.save()
	...
	bmID_288.save()
	bfID_288 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_288)
	bfID_288.save()
	...
	bmID_111.save()
	bfID_111 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_111)
	bfID_111.save()
	...
	bmID_50.save()
	bfID_50 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_50)
	bfID_50.save()
	...
	bmID_214.save()
	bfID_214 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_214)
	bfID_214.save()
	...
	bmID_237.save()
	bfID_237 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_237)
	bfID_237.save()
	...
	bmID_218.save()
	bfID_218 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_218)
	bfID_218.save()
	...
	bmID_244.save()
	bfID_244 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_244)
	bfID_244.save()
	bmID_327,bmID_b_327 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/tuebingen/')
	bmID_327.btitle='T bingen'
	bmID_327.save()
	bfID_327 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_327)
	bfID_327.save()
	bmID_157,bmID_b_157 = Bookmark.objects.get_or_create(url='http://www.larsko.org/v/euc/')
	bmID_157.btitle='Radar chart'
	bmID_157.save()
	bfID_157 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_157)
	bfID_157.save()
	...
	bmID_277.save()
	bfID_277 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_277)
	bfID_277.save()
	...
	bmID_86.save()
	bfID_86 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_86)
	bfID_86.save()
	bmID_139,bmID_b_139 = Bookmark.objects.get_or_create(url='http://ggruiz.me/weeknd3/')
	bmID_139.btitle='Weeknd3'
	bmID_139.save()
	bfID_139 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_139)
	bfID_139.save()
	...
	bmID_213.save()
	bfID_213 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_213)
	bfID_213.save()
	bmID_89,bmID_b_89 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1061834')
	bmID_89.btitle='Collapsible'
	bmID_89.save()
	bfID_89 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_89)
	bfID_89.save()
	...
	bmID_164.save()
	bfID_164 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_164)
	bfID_164.save()
	...
	bmID_143.save()
	bfID_143 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_143)
	bfID_143.save()
	...
	bmID_253.save()
	bfID_253 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_253)
	bfID_253.save()
	...
	bmID_311.save()
	bfID_311 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_311)
	bfID_311.save()
	...
	bmID_47.save()
	bfID_47 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_47)
	bfID_47.save()
	...
	bmID_287.save()
	bfID_287 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_287)
	bfID_287.save()
	...
	bmID_26.save()
	bfID_26 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gosel,bfbookmark=bmID_26)
	bfID_26.save()
	...
	bmID_105.save()
	bfID_105 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_105)
	bfID_105.save()
	bmID_250,bmID_b_250 = Bookmark.objects.get_or_create(url='http://trisul.org/')
	bmID_250.btitle='Trisul Network Analytic'
	bmID_250.save()
	bfID_250 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_250)
	bfID_250.save()
	bmID_72,bmID_b_72 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1080941')
	bmID_72.btitle='From XML'
	bmID_72.save()
	bfID_72 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_72)
	bfID_72.save()
	...
	bmID_163.save()
	bfID_163 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_163)
	bfID_163.save()
	...
	bmID_252.save()
	bfID_252 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_252)
	bfID_252.save()
	...
	bmID_137.save()
	bfID_137 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_137)
	bfID_137.save()
	...
	bmID_234.save()
	bfID_234 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_234)
	bfID_234.save()
	...
	bmID_15.save()
	bfID_15 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_15)
	bfID_15.save()
	...
	bmID_120.save()
	bfID_120 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_120)
	bfID_120.save()
	...
	bmID_304.save()
	bfID_304 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_304)
	bfID_304.save()
	...
	bmID_13.save()
	bfID_13 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_13)
	bfID_13.save()
	...
	bmID_195.save()
	bfID_195 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_195)
	bfID_195.save()
	...
	bmID_172.save()
	bfID_172 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_172)
	bfID_172.save()
	...
	bmID_316.save()
	bfID_316 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_316)
	bfID_316.save()
	bmID_140,bmID_b_140 = Bookmark.objects.get_or_create(url='http://ggruiz.me/explosions/')
	bmID_140.btitle='Explosions'
	bmID_140.save()
	bfID_140 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_140)
	bfID_140.save()
	...
	bmID_59.save()
	bfID_59 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_59)
	bfID_59.save()
	...
	bmID_4.save()
	bfID_4 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gosel,bfbookmark=bmID_4)
	bfID_4.save()
	...
	bmID_207.save()
	bfID_207 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_207)
	bfID_207.save()
	...
	bmID_315.save()
	bfID_315 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_315)
	bfID_315.save()
	bmID_312,bmID_b_312 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/wave/')
	bmID_312.btitle='Wave'
	bmID_312.save()
	bfID_312 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_312)
	bfID_312.save()
	...
	bmID_306.save()
	bfID_306 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_306)
	bfID_306.save()
	...
	bmID_67.save()
	bfID_67 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_67)
	bfID_67.save()
	...
	bmID_223.save()
	bfID_223 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_223)
	bfID_223.save()
	...
	bmID_91.save()
	bfID_91 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_91)
	bfID_91.save()
	bmID_135,bmID_b_135 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1062544')
	bmID_135.btitle='OMG Particles '
	bmID_135.save()
	bfID_135 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_135)
	bfID_135.save()
	...
	bmID_276.save()
	bfID_276 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_276)
	bfID_276.save()
	...
	bmID_337.save()
	bfID_337 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_337)
	bfID_337.save()
	...
	bmID_173.save()
	bfID_173 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_173)
	bfID_173.save()
	bmID_96,bmID_b_96 = Bookmark.objects.get_or_create(url='http://blockses.appspot.com/2503502')
	bmID_96.btitle='Bracket Layout'
	bmID_96.save()
	bfID_96 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_96)
	bfID_96.save()
	bmID_68,bmID_b_68 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/950642')
	bmID_68.btitle='Images and Labels'
	bmID_68.save()
	bfID_68 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_68)
	bfID_68.save()
	...
	bmID_61.save()
	bfID_61 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_61)
	bfID_61.save()
	...
	bmID_58.save()
	bfID_58 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Wen,bfbookmark=bmID_58)
	bfID_58.save()
	...
	bmID_188.save()
	bfID_188 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_188)
	bfID_188.save()
	...
	bmID_290.save()
	bfID_290 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_290)
	bfID_290.save()
	...
	bmID_205.save()
	bfID_205 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_205)
	bfID_205.save()
	...
	bmID_232.save()
	bfID_232 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_232)
	bfID_232.save()
	...
	bmID_266.save()
	bfID_266 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_266)
	bfID_266.save()
	...
	bmID_60.save()
	bfID_60 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_60)
	bfID_60.save()
	...
	bmID_242.save()
	bfID_242 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_242)
	bfID_242.save()
	...
	bmID_307.save()
	bfID_307 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_307)
	bfID_307.save()
	bmID_112,bmID_b_112 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/1046712')
	bmID_112.btitle='Static'
	bmID_112.save()
	bfID_112 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_112)
	bfID_112.save()
	...
	bmID_249.save()
	bfID_249 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_249)
	bfID_249.save()
	...
	bmID_222.save()
	bfID_222 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_222)
	bfID_222.save()
	...
	bmID_293.save()
	bfID_293 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_293)
	bfID_293.save()
	bmID_225,bmID_b_225 = Bookmark.objects.get_or_create(url='https://github.com/hadley/r2d3')
	bmID_225.btitle='ggplot2   d3   r2d3'
	bmID_225.save()
	bfID_225 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_225)
	bfID_225.save()
	...
	bmID_204.save()
	bfID_204 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_204)
	bfID_204.save()
	bmID_182,bmID_b_182 = Bookmark.objects.get_or_create(url='http://jsfiddle.net/7WQjr/')
	bmID_182.btitle='Simple HTML data tables'
	bmID_182.save()
	bfID_182 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_182)
	bfID_182.save()
	...
	bmID_129.save()
	bfID_129 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_129)
	bfID_129.save()
	...
	bmID_318.save()
	bfID_318 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_318)
	bfID_318.save()
	...
	bmID_57.save()
	bfID_57 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_57)
	bfID_57.save()
	...
	bmID_256.save()
	bfID_256 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_256)
	bfID_256.save()
	...
	bmID_254.save()
	bfID_254 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_254)
	bfID_254.save()
	...
	bmID_54.save()
	bfID_54 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_54)
	bfID_54.save()
	bmID_144,bmID_b_144 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1136236')
	bmID_144.btitle='Spermatozoa'
	bmID_144.save()
	bfID_144 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_144)
	bfID_144.save()
	...
	bmID_241.save()
	bfID_241 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_241)
	bfID_241.save()
	...
	bmID_38.save()
	bfID_38 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_38)
	bfID_38.save()
	...
	bmID_21.save()
	bfID_21 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_21)
	bfID_21.save()
	bmID_230,bmID_b_230 = Bookmark.objects.get_or_create(url='http://dexvis.com')
	bmID_230.btitle='Dex the Data Explorer'
	bmID_230.save()
	bfID_230 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_230)
	bfID_230.save()
	...
	bmID_71.save()
	bfID_71 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_71)
	bfID_71.save()
	...
	bmID_63.save()
	bfID_63 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_63)
	bfID_63.save()
	bmID_158,bmID_b_158 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1629464')
	bmID_158.btitle='Drag rectangle'
	bmID_158.save()
	bfID_158 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_158)
	bfID_158.save()
	bmID_82,bmID_b_82 = Bookmark.objects.get_or_create(url='http://disqus.com/gravity')
	bmID_82.btitle='Gravity by Disqus'
	bmID_82.save()
	bfID_82 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_82)
	bfID_82.save()
	bmID_16,bmID_b_16 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/882152')
	bmID_16.btitle='Grouped Bar Chart'
	bmID_16.save()
	bfID_16 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_16)
	bfID_16.save()
	...
	bmID_9.save()
	bfID_9 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_9)
	bfID_9.save()
	...
	bmID_78.save()
	bfID_78 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_78)
	bfID_78.save()
	...
	bmID_10.save()
	bfID_10 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_10)
	bfID_10.save()
	...
	bmID_98.save()
	bfID_98 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_98)
	bfID_98.save()
	bmID_65,bmID_b_65 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1021841')
	bmID_65.btitle='Custom Forces'
	bmID_65.save()
	bfID_65 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_65)
	bfID_65.save()
	...
	bmID_166.save()
	bfID_166 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_166)
	bfID_166.save()
	...
	bmID_3.save()
	bfID_3 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_3)
	bfID_3.save()
	...
	bmID_294.save()
	bfID_294 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_294)
	bfID_294.save()
	...
	bmID_324.save()
	bfID_324 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_324)
	bfID_324.save()
	...
	bmID_44.save()
	bfID_44 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gosel,bfbookmark=bmID_44)
	bfID_44.save()
	...
	bmID_107.save()
	bfID_107 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_107)
	bfID_107.save()
	...
	bmID_90.save()
	bfID_90 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_90)
	bfID_90.save()
	...
	bmID_201.save()
	bfID_201 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_201)
	bfID_201.save()
	...
	bmID_114.save()
	bfID_114 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_114)
	bfID_114.save()
	...
	bmID_258.save()
	bfID_258 = BookmarkToFolder.objects.create(bffolder=f_Store_Apps_Martyna,bfbookmark=bmID_258)
	bfID_258.save()
	...
	bmID_323.save()
	bfID_323 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_323)
	bfID_323.save()
	bmID_334,bmID_b_334 = Bookmark.objects.get_or_create(url='http://vallandingham.me/feltronifier/')
	bmID_334.btitle='Feltronifier'
	bmID_334.save()
	bfID_334 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_334)
	bfID_334.save()
	...
	bmID_314.save()
	bfID_314 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_314)
	bfID_314.save()
	bmID_113,bmID_b_113 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/1308257')
	bmID_113.btitle='Static'
	bmID_113.save()
	bfID_113 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_113)
	bfID_113.save()
	...
	bmID_33.save()
	bfID_33 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_33)
	bfID_33.save()
	...
	bmID_282.save()
	bfID_282 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_282)
	bfID_282.save()
	...
	bmID_229.save()
	bfID_229 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_229)
	bfID_229.save()
	...
	bmID_199.save()
	bfID_199 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_199)
	bfID_199.save()
	bmID_248,bmID_b_248 = Bookmark.objects.get_or_create(url='http://plot.io/')
	bmID_248.btitle='Plot io  swallowed by Platfora '
	bmID_248.save()
	bfID_248 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_248)
	bfID_248.save()
	...
	bmID_298.save()
	bfID_298 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_298)
	bfID_298.save()
	...
	bmID_202.save()
	bfID_202 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_202)
	bfID_202.save()
	...
	bmID_320.save()
	bfID_320 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_320)
	bfID_320.save()
	bmID_185,bmID_b_185 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/3689677')
	bmID_185.btitle='Long Scroll'
	bmID_185.save()
	bfID_185 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_185)
	bfID_185.save()
	...
	bmID_39.save()
	bfID_39 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_39)
	bfID_39.save()
	...
	bmID_48.save()
	bfID_48 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_48)
	bfID_48.save()
	...
	bmID_73.save()
	bfID_73 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_73)
	bfID_73.save()
	...
	bmID_37.save()
	bfID_37 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_37)
	bfID_37.save()
	...
	bmID_226.save()
	bfID_226 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_226)
	bfID_226.save()
	bmID_22,bmID_b_22 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/rsloan/7123450')
	bmID_22.btitle='Waterfall Chart'
	bmID_22.save()
	bfID_22 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_22)
	bfID_22.save()
	...
	bmID_191.save()
	bfID_191 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_191)
	bfID_191.save()
	...
	bmID_189.save()
	bfID_189 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_189)
	bfID_189.save()
	bmID_127,bmID_b_127 = Bookmark.objects.get_or_create(url='http://dyninc.github.com/d3-smokechart/')
	bmID_127.btitle='Smoke charts'
	bmID_127.save()
	bfID_127 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_127)
	bfID_127.save()
	...
	bmID_326.save()
	bfID_326 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_326)
	bfID_326.save()
	bmID_87,bmID_b_87 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/2966094')
	bmID_87.btitle='Pedigree Tree'
	bmID_87.save()
	bfID_87 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_87)
	bfID_87.save()
	...
	bmID_94.save()
	bfID_94 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_94)
	bfID_94.save()
	...
	bmID_296.save()
	bfID_296 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_296)
	bfID_296.save()
	bmID_42,bmID_b_42 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1305111')
	bmID_42.btitle='Pie Multiples'
	bmID_42.save()
	bfID_42 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gosel,bfbookmark=bmID_42)
	bfID_42.save()
	...
	bmID_295.save()
	bfID_295 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_295)
	bfID_295.save()
	...
	bmID_23.save()
	bfID_23 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_23)
	bfID_23.save()
	...
	bmID_198.save()
	bfID_198 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_198)
	bfID_198.save()
	...
	bmID_2.save()
	bfID_2 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_2)
	bfID_2.save()
	...
	bmID_5.save()
	bfID_5 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gosel,bfbookmark=bmID_5)
	bfID_5.save()
	...
	bmID_286.save()
	bfID_286 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_286)
	bfID_286.save()
	bmID_124,bmID_b_124 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/2011590')
	bmID_124.btitle='Chernoff faces'
	bmID_124.save()
	bfID_124 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_124)
	bfID_124.save()
	...
	bmID_184.save()
	bfID_184 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_184)
	bfID_184.save()
	...
	bmID_14.save()
	bfID_14 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_14)
	bfID_14.save()
	...
	bmID_339.save()
	bfID_339 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_339)
	bfID_339.save()
	...
	bmID_279.save()
	bfID_279 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_279)
	bfID_279.save()
	bmID_149,bmID_b_149 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1243323')
	bmID_149.btitle='Merge Sort'
	bmID_149.save()
	bfID_149 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_149)
	bfID_149.save()
	...
	bmID_206.save()
	bfID_206 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_206)
	bfID_206.save()
	bmID_126,bmID_b_126 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/2280295')
	bmID_126.btitle='Pictograms'
	bmID_126.save()
	bfID_126 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_126)
	bfID_126.save()
	...
	bmID_238.save()
	bfID_238 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_238)
	bfID_238.save()
	...
	bmID_274.save()
	bfID_274 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_274)
	bfID_274.save()
	...
	bmID_336.save()
	bfID_336 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_336)
	bfID_336.save()
	...
	bmID_46.save()
	bfID_46 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_46)
	bfID_46.save()
	...
	bmID_83.save()
	bfID_83 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_83)
	bfID_83.save()
	...
	bmID_197.save()
	bfID_197 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_197)
	bfID_197.save()
	...
	bmID_123.save()
	bfID_123 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_123)
	bfID_123.save()
	...
	bmID_7.save()
	bfID_7 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_7)
	bfID_7.save()
	...
	bmID_267.save()
	bfID_267 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_267)
	bfID_267.save()
	...
	bmID_224.save()
	bfID_224 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_224)
	bfID_224.save()
	...
	bmID_92.save()
	bfID_92 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_92)
	bfID_92.save()
	bmID_151,bmID_b_151 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1276463')
	bmID_151.btitle='DOM to Canvas'
	bmID_151.save()
	bfID_151 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_151)
	bfID_151.save()
	...
	bmID_268.save()
	bfID_268 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_268)
	bfID_268.save()
	...
	bmID_243.save()
	bfID_243 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_243)
	bfID_243.save()
	...
	bmID_153.save()
	bfID_153 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_153)
	bfID_153.save()
	...
	bmID_330.save()
	bfID_330 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_330)
	bfID_330.save()
	...
	bmID_81.save()
	bfID_81 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_81)
	bfID_81.save()
	...
	bmID_49.save()
	bfID_49 = BookmarkToFolder.objects.create(bffolder=f_Scatterplot_and_Bubble_chart_Gosel,bfbookmark=bmID_49)
	bfID_49.save()
	...
	bmID_281.save()
	bfID_281 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_281)
	bfID_281.save()
	...
	bmID_93.save()
	bfID_93 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_93)
	bfID_93.save()
	...
	bmID_329.save()
	bfID_329 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_329)
	bfID_329.save()
	...
	bmID_51.save()
	bfID_51 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_51)
	bfID_51.save()
	...
	bmID_161.save()
	bfID_161 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_161)
	bfID_161.save()
	...
	bmID_80.save()
	bfID_80 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_80)
	bfID_80.save()
	bmID_263,bmID_b_263 = Bookmark.objects.get_or_create(url='http://square.github.com/crossfilter/')
	bmID_263.btitle='Crossfilter'
	bmID_263.save()
	bfID_263 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_263)
	bfID_263.save()
	...
	bmID_310.save()
	bfID_310 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_310)
	bfID_310.save()
	...
	bmID_160.save()
	bfID_160 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_160)
	bfID_160.save()
	...
	bmID_342.save()
	bfID_342 = BookmarkToFolder.objects.create(bffolder=f_bin_Jean,bfbookmark=bmID_342)
	bfID_342.save()
	...
	bmID_181.save()
	bfID_181 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_181)
	bfID_181.save()
	...
	bmID_215.save()
	bfID_215 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_215)
	bfID_215.save()
	...
	bmID_31.save()
	bfID_31 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_31)
	bfID_31.save()
	bmID_35,bmID_b_35 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1483226')
	bmID_35.btitle='Horizon Chart'
	bmID_35.save()
	bfID_35 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_35)
	bfID_35.save()
	...
	bmID_305.save()
	bfID_305 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_305)
	bfID_305.save()
	...
	bmID_292.save()
	bfID_292 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_292)
	bfID_292.save()
	...
	bmID_285.save()
	bfID_285 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_285)
	bfID_285.save()
	...
	bmID_102.save()
	bfID_102 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_102)
	bfID_102.save()
	...
	bmID_56.save()
	bfID_56 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_56)
	bfID_56.save()
	...
	bmID_203.save()
	bfID_203 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_203)
	bfID_203.save()
	...
	bmID_208.save()
	bfID_208 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_208)
	bfID_208.save()
	bmID_55,bmID_b_55 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/parallel-sets/')
	bmID_55.btitle='Parallel Sets'
	bmID_55.save()
	bfID_55 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_55)
	bfID_55.save()
	...
	bmID_328.save()
	bfID_328 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_328)
	bfID_328.save()
	bmID_269,bmID_b_269 = Bookmark.objects.get_or_create(url='http://sepans.com/sp/postes/lepracursor/')
	bmID_269.btitle='Lepracursor'
	bmID_269.save()
	bfID_269 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_269)
	bfID_269.save()
	...
	bmID_74.save()
	bfID_74 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_74)
	bfID_74.save()
	...
	bmID_0.save()
	bfID_0 = BookmarkToFolder.objects.create(bffolder=f_Maps_Gosel,bfbookmark=bmID_0)
	bfID_0.save()
	...
	bmID_52.save()
	bfID_52 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_52)
	bfID_52.save()
	...
	bmID_156.save()
	bfID_156 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_156)
	bfID_156.save()
	...
	bmID_75.save()
	bfID_75 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_75)
	bfID_75.save()
	...
	bmID_211.save()
	bfID_211 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_211)
	bfID_211.save()
	...
	bmID_12.save()
	bfID_12 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_12)
	bfID_12.save()
	...
	bmID_325.save()
	bfID_325 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_325)
	bfID_325.save()
	...
	bmID_19.save()
	bfID_19 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_19)
	bfID_19.save()
	bmID_175,bmID_b_175 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1071269')
	bmID_175.btitle='Date Ticks'
	bmID_175.save()
	bfID_175 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_175)
	bfID_175.save()
	...
	bmID_176.save()
	bfID_176 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_176)
	bfID_176.save()
	...
	bmID_322.save()
	bfID_322 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_322)
	bfID_322.save()
	bmID_25,bmID_b_25 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1933560')
	bmID_25.btitle='Histogram Chart'
	bmID_25.save()
	bfID_25 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gosel,bfbookmark=bmID_25)
	bfID_25.save()
	...
	bmID_283.save()
	bfID_283 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_283)
	bfID_283.save()
	...
	bmID_70.save()
	bfID_70 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_70)
	bfID_70.save()
	...
	bmID_240.save()
	bfID_240 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_240)
	bfID_240.save()
	...
	bmID_335.save()
	bfID_335 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_335)
	bfID_335.save()
	...
	bmID_341.save()
	bfID_341 = BookmarkToFolder.objects.create(bffolder=f_bin_Wen,bfbookmark=bmID_341)
	bfID_341.save()
	...
	bmID_18.save()
	bfID_18 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_18)
	bfID_18.save()
	...
	bmID_313.save()
	bfID_313 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_313)
	bfID_313.save()
	bmID_148,bmID_b_148 = Bookmark.objects.get_or_create(url='http://vvvvjs.quasipartikel.at/')
	bmID_148.btitle='VVVV viewer'
	bmID_148.save()
	bfID_148 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_148)
	bfID_148.save()
	bmID_155,bmID_b_155 = Bookmark.objects.get_or_create(url='https://github.com/boorad/d3-tsline')
	bmID_155.btitle='Time Series'
	bmID_155.save()
	bfID_155 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_155)
	bfID_155.save()
	bmID_141,bmID_b_141 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1086421')
	bmID_141.btitle='Linear Gradients'
	bmID_141.save()
	bfID_141 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_141)
	bfID_141.save()
	...
	bmID_84.save()
	bfID_84 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_84)
	bfID_84.save()
	...
	bmID_265.save()
	bfID_265 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_265)
	bfID_265.save()
	...
	bmID_264.save()
	bfID_264 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_264)
	bfID_264.save()
	bmID_125,bmID_b_125 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1962173')
	bmID_125.btitle='Swimlane Chart'
	bmID_125.save()
	bfID_125 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_125)
	bfID_125.save()
	bmID_284,bmID_b_284 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/bubbles/')
	bmID_284.btitle='Bubbles'
	bmID_284.save()
	bfID_284 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_284)
	bfID_284.save()
	bmID_97,bmID_b_97 = Bookmark.objects.get_or_create(url='http://bit.ly/PvWgUH')
	bmID_97.btitle='SCION simulation environment'
	bmID_97.save()
	bfID_97 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_97)
	bfID_97.save()
	...
	bmID_219.save()
	bfID_219 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_219)
	bfID_219.save()
	...
	bmID_36.save()
	bfID_36 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_36)
	bfID_36.save()
	bmID_297,bmID_b_297 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/planarity/')
	bmID_297.btitle='Planarity'
	bmID_297.save()
	bfID_297 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_297)
	bfID_297.save()
	bmID_302,bmID_b_302 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/bloomfilter/')
	bmID_302.btitle='Bloom Filters'
	bmID_302.save()
	bfID_302 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_302)
	bfID_302.save()
	bmID_122,bmID_b_122 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1005090')
	bmID_122.btitle='Marimekko Chart'
	bmID_122.save()
	bfID_122 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_122)
	bfID_122.save()
	...
	bmID_338.save()
	bfID_338 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_338)
	bfID_338.save()
	...
	bmID_131.save()
	bfID_131 = BookmarkToFolder.objects.create(bffolder=f_Misc_Charts_Jean,bfbookmark=bmID_131)
	bfID_131.save()
	...
	bmID_212.save()
	bfID_212 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_212)
	bfID_212.save()
	...
	bmID_99.save()
	bfID_99 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_99)
	bfID_99.save()
	...
	bmID_133.save()
	bfID_133 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_133)
	bfID_133.save()
	...
	bmID_95.save()
	bfID_95 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_95)
	bfID_95.save()
	...
	bmID_303.save()
	bfID_303 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_303)
	bfID_303.save()
	...
	bmID_159.save()
	bfID_159 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_159)
	bfID_159.save()
	...
	bmID_332.save()
	bfID_332 = BookmarkToFolder.objects.create(bffolder=f_Jim_Vallandingham_James,bfbookmark=bmID_332)
	bfID_332.save()
	...
	bmID_76.save()
	bfID_76 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_76)
	bfID_76.save()
	...
	bmID_186.save()
	bfID_186 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_186)
	bfID_186.save()
	...
	bmID_162.save()
	bfID_162 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_162)
	bfID_162.save()
	...
	bmID_270.save()
	bfID_270 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_270)
	bfID_270.save()
	...
	bmID_101.save()
	bfID_101 = BookmarkToFolder.objects.create(bffolder=f_Misc_Trees_and_Graphs_Wen,bfbookmark=bmID_101)
	bfID_101.save()
	bmID_260,bmID_b_260 = Bookmark.objects.get_or_create(url='http://nvd3.org/')
	bmID_260.btitle='NVD3'
	bmID_260.save()
	bfID_260 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_260)
	bfID_260.save()
	bmID_109,bmID_b_109 = Bookmark.objects.get_or_create(url='http://livecoding.io/3419309')
	bmID_109.btitle='Fade on Hover'
	bmID_109.save()
	bfID_109 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_109)
	bfID_109.save()
	...
	bmID_6.save()
	bfID_6 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Gosel,bfbookmark=bmID_6)
	bfID_6.save()
	...
	bmID_340.save()
	bfID_340 = BookmarkToFolder.objects.create(bffolder=f_bin_James,bfbookmark=bmID_340)
	bfID_340.save()
	...
	bmID_24.save()
	bfID_24 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gosel,bfbookmark=bmID_24)
	bfID_24.save()
	bmID_41,bmID_b_41 = Bookmark.objects.get_or_create(url='https://github.com/gajus/pie-chart')
	bmID_41.btitle='Reusable Pie Charts'
	bmID_41.save()
	bfID_41 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gosel,bfbookmark=bmID_41)
	bfID_41.save()
	...
	bmID_317.save()
	bfID_317 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_317)
	bfID_317.save()
	...
	bmID_289.save()
	bfID_289 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_289)
	bfID_289.save()
	...
	bmID_321.save()
	bfID_321 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_321)
	bfID_321.save()
	...
	bmID_174.save()
	bfID_174 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_174)
	bfID_174.save()
	...
	bmID_280.save()
	bfID_280 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_280)
	bfID_280.save()
	...
	bmID_43.save()
	bfID_43 = BookmarkToFolder.objects.create(bffolder=f_Pie_Chart_Gosel,bfbookmark=bmID_43)
	bfID_43.save()
	bmID_66,bmID_b_66 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1021953')
	bmID_66.btitle='Multiple Foci'
	bmID_66.save()
	bfID_66 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_66)
	bfID_66.save()
	...
	bmID_103.save()
	bfID_103 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_103)
	bfID_103.save()
	bmID_17,bmID_b_17 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1134768')
	bmID_17.btitle='Stacked Bar Chart'
	bmID_17.save()
	bfID_17 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_17)
	bfID_17.save()
	...
	bmID_106.save()
	bfID_106 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_106)
	bfID_106.save()
	...
	bmID_228.save()
	bfID_228 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_228)
	bfID_228.save()
	bmID_217,bmID_b_217 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/2294676')
	bmID_217.btitle='SVG to Canvas'
	bmID_217.save()
	bfID_217 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_217)
	bfID_217.save()
	...
	bmID_300.save()
	bfID_300 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_300)
	bfID_300.save()
	...
	bmID_309.save()
	bfID_309 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_309)
	bfID_309.save()
	...
	bmID_62.save()
	bfID_62 = BookmarkToFolder.objects.create(bffolder=f_Sunburst_and_Partition_layout_Wen,bfbookmark=bmID_62)
	bfID_62.save()
	...
	bmID_168.save()
	bfID_168 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_168)
	bfID_168.save()
	...
	bmID_115.save()
	bfID_115 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Jean,bfbookmark=bmID_115)
	bfID_115.save()
	bmID_257,bmID_b_257 = Bookmark.objects.get_or_create(url='http://mortgagebloom.com')
	bmID_257.btitle='MortgageBloom Calculator'
	bmID_257.save()
	bfID_257 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_257)
	bfID_257.save()
	bmID_261,bmID_b_261 = Bookmark.objects.get_or_create(url='http://dimplejs.org/')
	bmID_261.btitle='Dimple'
	bmID_261.save()
	bfID_261 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_261)
	bfID_261.save()
	...
	bmID_85.save()
	bfID_85 = BookmarkToFolder.objects.create(bffolder=f_Tree_Wen,bfbookmark=bmID_85)
	bfID_85.save()
	...
	bmID_145.save()
	bfID_145 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_145)
	bfID_145.save()
	...
	bmID_8.save()
	bfID_8 = BookmarkToFolder.objects.create(bffolder=f_Institute_for_Health_Metrics_and_Evaluation_Gosel,bfbookmark=bmID_8)
	bfID_8.save()
	...
	bmID_275.save()
	bfID_275 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_275)
	bfID_275.save()
	bmID_165,bmID_b_165 = Bookmark.objects.get_or_create(url='http://dan.iel.fm/xkcd/')
	bmID_165.btitle='XKCD style plots'
	bmID_165.save()
	bfID_165 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_165)
	bfID_165.save()
	...
	bmID_247.save()
	bfID_247 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_247)
	bfID_247.save()
	...
	bmID_32.save()
	bfID_32 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_32)
	bfID_32.save()
	...
	bmID_246.save()
	bfID_246 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_246)
	bfID_246.save()
	...
	bmID_301.save()
	bfID_301 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_301)
	bfID_301.save()
	...
	bmID_221.save()
	bfID_221 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_221)
	bfID_221.save()
	...
	bmID_179.save()
	bfID_179 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_179)
	bfID_179.save()
	...
	bmID_216.save()
	bfID_216 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_216)
	bfID_216.save()
	bmID_104,bmID_b_104 = Bookmark.objects.get_or_create(url='http://www.torre.nl/remittances/')
	bmID_104.btitle='Remittance flows'
	bmID_104.save()
	bfID_104 = BookmarkToFolder.objects.create(bffolder=f_Chord_Layout_Wen,bfbookmark=bmID_104)
	bfID_104.save()
	...
	bmID_255.save()
	bfID_255 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_255)
	bfID_255.save()
	...
	bmID_69.save()
	bfID_69 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_69)
	bfID_69.save()
	...
	bmID_236.save()
	bfID_236 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Jean,bfbookmark=bmID_236)
	bfID_236.save()
	...
	bmID_28.save()
	bfID_28 = BookmarkToFolder.objects.create(bffolder=f_Histogram_Gosel,bfbookmark=bmID_28)
	bfID_28.save()
	...
	bmID_171.save()
	bfID_171 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_171)
	bfID_171.save()
	...
	bmID_233.save()
	bfID_233 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_233)
	bfID_233.save()
	...
	bmID_196.save()
	bfID_196 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_196)
	bfID_196.save()
	...
	bmID_262.save()
	bfID_262 = BookmarkToFolder.objects.create(bffolder=f_Libraries_Martyna,bfbookmark=bmID_262)
	bfID_262.save()
	...
	bmID_227.save()
	bfID_227 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_227)
	bfID_227.save()
	...
	bmID_193.save()
	bfID_193 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_193)
	bfID_193.save()
	...
	bmID_273.save()
	bfID_273 = BookmarkToFolder.objects.create(bffolder=f_Jerome_Cukier_Martyna,bfbookmark=bmID_273)
	bfID_273.save()
	...
	bmID_251.save()
	bfID_251 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_251)
	bfID_251.save()
	bmID_138,bmID_b_138 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/849853')
	bmID_138.btitle='Raindrops'
	bmID_138.save()
	bfID_138 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_138)
	bfID_138.save()
	...
	bmID_239.save()
	bfID_239 = BookmarkToFolder.objects.create(bffolder=f_Online_Editors_Martyna,bfbookmark=bmID_239)
	bfID_239.save()
	...
	bmID_142.save()
	bfID_142 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_142)
	bfID_142.save()
	...
	bmID_209.save()
	bfID_209 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_209)
	bfID_209.save()
	...
	bmID_34.save()
	bfID_34 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_34)
	bfID_34.save()
	...
	bmID_319.save()
	bfID_319 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_James,bfbookmark=bmID_319)
	bfID_319.save()
	...
	bmID_245.save()
	bfID_245 = BookmarkToFolder.objects.create(bffolder=f_Products_Martyna,bfbookmark=bmID_245)
	bfID_245.save()
	bmID_291,bmID_b_291 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/rhodonea/')
	bmID_291.btitle='Rhodonea Curve'
	bmID_291.save()
	bfID_291 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_291)
	bfID_291.save()
	bmID_29,bmID_b_29 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1166403')
	bmID_29.btitle='Axis Component'
	bmID_29.save()
	bfID_29 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_29)
	bfID_29.save()
	...
	bmID_200.save()
	bfID_200 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_200)
	bfID_200.save()
	...
	bmID_20.save()
	bfID_20 = BookmarkToFolder.objects.create(bffolder=f_Bar_Chart_Gosel,bfbookmark=bmID_20)
	bfID_20.save()
	...
	bmID_79.save()
	bfID_79 = BookmarkToFolder.objects.create(bffolder=f_Force_Layout_Wen,bfbookmark=bmID_79)
	bfID_79.save()
	...
	bmID_53.save()
	bfID_53 = BookmarkToFolder.objects.create(bffolder=f_Parallel_Coordinates_Parallel_sets_and_Sankey_Gosel,bfbookmark=bmID_53)
	bfID_53.save()
	...
	bmID_170.save()
	bfID_170 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_170)
	bfID_170.save()
	bmID_147,bmID_b_147 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1256572')
	bmID_147.btitle='Show Reel'
	bmID_147.save()
	bfID_147 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_147)
	bfID_147.save()
	bmID_190,bmID_b_190 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/3605124')
	bmID_190.btitle='Axis Examples'
	bmID_190.save()
	bfID_190 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_190)
	bfID_190.save()
	bmID_30,bmID_b_30 = Bookmark.objects.get_or_create(url='http://bl.ocks.org/mbostock/1157787')
	bmID_30.btitle='Small Multiples'
	bmID_30.save()
	bfID_30 = BookmarkToFolder.objects.create(bffolder=f_Line_and_Area_Chart_Gosel,bfbookmark=bmID_30)
	bfID_30.save()
	...
	bmID_119.save()
	bfID_119 = BookmarkToFolder.objects.create(bffolder=f_Maps_Jean,bfbookmark=bmID_119)
	bfID_119.save()
	...
	bmID_210.save()
	bfID_210 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_210)
	bfID_210.save()
	...
	bmID_220.save()
	bfID_220 = BookmarkToFolder.objects.create(bffolder=f_Interoperability_Jean,bfbookmark=bmID_220)
	bfID_220.save()
	...
	bmID_194.save()
	bfID_194 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_194)
	bfID_194.save()
	...
	bmID_167.save()
	bfID_167 = BookmarkToFolder.objects.create(bffolder=f_Miscellaneous_visualizations_Jean,bfbookmark=bmID_167)
	bfID_167.save()
	bmID_278,bmID_b_278 = Bookmark.objects.get_or_create(url='http://www.jasondavies.com/maps/antipodes/')
	bmID_278.btitle='Antipodes'
	bmID_278.save()
	bfID_278 = BookmarkToFolder.objects.create(bffolder=f_Jason_Davies_Martyna,bfbookmark=bmID_278)
	bfID_278.save()
	...
	bmID_187.save()
	bfID_187 = BookmarkToFolder.objects.create(bffolder=f_Useful_snippets_Jean,bfbookmark=bmID_187)
	bfID_187.save()
